  ...
  return (
    ...
    >
      ...
      >
        ...
        <path d="M12 0C5.373 0 0 5.373 0 12c0 2.124.558 4.121 1.533 5.857L.057 23.625a.75.75 0 0 0 .921.921l5.768-1.476A11.95 11.95 0 0 0 12 24c6.627 0 12-5.373 12-12S18.627 0 12 0zm0 21.75a9.695 9.695 0 0 1-4.943-1.352l-.355-.211-3.673.94.957-3.498-.232-.365A9.69 9.69 0 0 1 2.25 12C2.25 6.615 6.615 2.25 12 2.25S21.75 6.615 21.75 12 17.385 21.75 12 21.75z" />
      </svg>
    </a>
  )
}
