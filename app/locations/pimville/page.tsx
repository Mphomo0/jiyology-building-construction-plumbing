...
export default function PimvillePage() {
  return (
    <>
            <script type="application/ld+json" dangerouslySetInnerHTML={{__html: JSON.stringify(locationServiceLdJson('Pimville', 'https://www.jiyology.co.za/locations/pimville'))}} />
