...
export const metadata: Metadata = {
  title: 'Plumber & Builder in Pimville | Jiyology Construction',
  description: 'Trusted plumber and builder in Pimville, Soweto. Plumbing, construction, roofing, renovations & emergency services. SABS approved, BEE Level 1. Free quotes.',
  openGraph: {
    title: 'Best Plumber & Builder in Pimville | Jiyology',
    description: 'Professional plumbing, construction, and renovation services in Pimville, Soweto. SABS approved materials, BEE Level 1. Free quotes for all projects.',
...
const faqs = [
  { q: 'Do you offer emergency plumbing in Pimville?', a: 'Yes. We provide 24/7 emergency plumbing in Pimville for burst pipes, blocked drains, overflowing toilets, and geyser failures. Call (011) 931 0157.' },
  { q: 'Can you build a granny flat in my Pimville backyard?', a: 'Absolutely. We design and build granny flats, backyard rooms, and rental units in Pimville. We handle all plans, approvals, and construction.' },
  { q: 'Do you replace old bathtubs with showers in Pimville?', a: 'Yes. Bathroom remodelling is one of our specialties. We can convert your old bathtub into a modern walk-in shower with tiling and plumbing included.' },
  { q: 'How long does a typical renovation take in Pimville?', a: 'Small bathroom renovations take about one week. Full kitchen remodels take two to three weeks. We provide a timeline with every quote.' },
]

export default function PimvillePage() {
  return (
    <>
      <Script id="pimville-faq-schema" type="application/ld+json">
        {JSON.stringify(faqLdJson(faqs))}
      </Script>
      <Script id="pimville-breadcrumb" type="application/ld+json">
        {JSON.stringify(breadcrumbLdJson([
          { name: 'Home', url: 'https://www.jiyology.co.za' },
          { name: 'Locations', url: 'https://www.jiyology.co.za/locations' },
          { name: 'Pimville', url: 'https://www.jiyology.co.za/locations/pimville' },
        ]))}
      </Script>

      <section className="relative pt-32 pb-20 md:pt-40 md:pb-28 bg-slate-950 overflow-hidden" aria-label="Pimville">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 z-10 text-center">
          <nav aria-label="Breadcrumb" className="mb-6">
            <ol className="flex items-center justify-center gap-2 text-sm text-neutral-400">
              ...
              <li><span className="mx-2">/</span></li>
              <li className="text-white font-medium" aria-current="page">Pimville</li>
            </ol>
          </nav>
          ...
          <p className="text-lg md:text-xl text-neutral-400 leading-relaxed max-w-3xl mx-auto">
            Jiyology Building Construction & Plumbing is Pimville trusted choice for plumbing repairs, home construction, and renovations. SABS-approved materials, BEE Level 1, and over 10 years of experience.
          </p>
      ...
      <section className="py-20 bg-background" aria-label="About serving Pimville">
        <div className="container mx-auto px-4 max-w-6xl">
          <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-6">Your Local Plumber & Builder in Pimville</h2>
          <div className="grid md:grid-cols-2 gap-12">
            <div>
              <p className="text-lg text-muted-foreground leading-relaxed mb-6">
                Pimville is one of Soweto oldest and most beloved suburbs, known for its strong community spirit and well-kept homes. Jiyology Building Construction & Plumbing has been serving Pimville residents for over 10 years, providing everything from small plumbing fixes to major home renovations.
              </p>
              <p className="text-lg text-muted-foreground leading-relaxed mb-6">
                Our plumbers are experienced with Pimville older plumbing systems, often replacing outdated galvanised pipes and cast-iron drainage with modern PVC and copper. We also handle new builds and extensions for families looking to add space and value to their Pimville properties.
              </p>
              <p className="text-lg text-muted-foreground leading-relaxed">
                Whether you have a dripping tap, a blocked drain, or you want to build a new home from scratch, our team is ready to help. We are NHBRC registered, SABS approved, and Level One 135% BEE compliant. Quality and reliability come standard with every job in Pimville.
              </p>
            </div>
            <div className="bg-muted/30 rounded-2xl p-8 border border-border/60">
              <h3 className="text-xl font-bold text-foreground mb-4">Our Services in Pimville</h3>
      ...
      <section className="py-20 bg-muted/30" aria-label="Soweto suburbs">
        <div className="container mx-auto px-4 max-w-6xl">
          <h2 className="text-3xl font-bold text-foreground mb-6 text-center">We Serve the Whole of Soweto Including Pimville</h2>
          <p className="text-lg text-muted-foreground text-center mb-12 max-w-3xl mx-auto">
            Pimville is just one of the many Soweto suburbs we serve. Our team covers the entire township for all plumbing, construction, and renovation projects.
          </p>
      ...
      <section className="py-20 bg-background" aria-label="FAQs">
        <div className="container mx-auto px-4 max-w-3xl">
          <h2 className="text-3xl font-bold text-foreground mb-8 text-center">Frequently Asked Questions About Our Pimville Services</h2>
