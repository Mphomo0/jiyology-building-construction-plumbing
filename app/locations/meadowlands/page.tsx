...
export const metadata: Metadata = {
  title: 'Builders in Meadowlands | Jiyology Construction',
  description: 'Professional builders and construction company in Meadowlands, Soweto. Plumbing, roofing, renovations, paving & building services. SABS approved, BEE Level 1. Free quotes.',
  openGraph: {
    title: 'Best Builders in Meadowlands | Jiyology Construction & Plumbing',
    description: 'Professional construction, plumbing, and renovation services in Meadowlands, Soweto. SABS approved materials, BEE Level 1. Free quotes for all projects.',
...
const faqs = [
  { q: 'Do you build houses in Meadowlands Zone 5?', a: 'Yes. We construct new homes in Meadowlands Zone 5 and all other zones. From foundation to finishing, we manage every phase of construction.' },
  { q: 'Can you fix leaking roofs in Meadowlands old houses?', a: 'Absolutely. Many older Meadowlands homes need roof repairs. We replace damaged roof sheets, fix flashing, and treat leaks to protect your home from weather damage.' },
  { q: 'Do you install ceilings in Meadowlands?', a: 'Yes. We install new ceilings using quality materials and repair existing damaged ceilings. We serve both residential and commercial clients in Meadowlands.' },
  { q: 'What are your payment terms for Meadowlands projects?', a: 'We offer flexible payment plans. A deposit is required upfront, with progress payments tied to project milestones. Final payment is due on completion and satisfaction.' },
]
    ...
    <>
      ...
      <Script id="meadowlands-breadcrumb" type="application/ld+json">
        {JSON.stringify(breadcrumbLdJson([
          ...
          { name: 'Meadowlands', url: 'https://www.jiyology.co.za/locations/meadowlands' },
        ]))}
      </Script>

      <section className="relative pt-32 pb-20 md:pt-40 md:pb-28 bg-slate-950 overflow-hidden" aria-label="Meadowlands">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 z-10 text-center">
          <nav aria-label="Breadcrumb" className="mb-6">
            <ol className="flex items-center justify-center gap-2 text-sm text-neutral-400">
              ...
              <li><span className="mx-2">/</span></li>
              <li className="text-white font-medium" aria-current="page">Meadowlands</li>
            </ol>
          </nav>
          ...
          <p className="text-lg md:text-xl text-neutral-400 leading-relaxed max-w-3xl mx-auto">
            Jiyology Building Construction & Plumbing delivers quality construction, maintenance, and plumbing services in Meadowlands. SABS-approved materials, BEE Level 1, and over 10 years serving Soweto.
          </p>
      ...
      <section className="py-20 bg-background" aria-label="About serving Meadowlands">
        <div className="container mx-auto px-4 max-w-6xl">
          <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-6">Your Local Builders in Meadowlands</h2>
          <div className="grid md:grid-cols-2 gap-12">
            <div>
              <p className="text-lg text-muted-foreground leading-relaxed mb-6">
                Meadowlands holds a special place in Soweto history, and its homes reflect generations of family pride. Jiyology Building Construction & Plumbing has been privileged to serve Meadowlands homeowners, helping them maintain, renovate, and build properties across all zones.
              </p>
              <p className="text-lg text-muted-foreground leading-relaxed mb-6">
                Meadowlands has a mix of older council-built houses and newer private developments. We are equally skilled at upgrading existing structures replacing old plumbing, installing new ceilings, reinforcing roofs and building brand-new homes on vacant plots. Our team understands the specific challenges of working in Meadowlands, from soil conditions to municipal compliance.
              </p>
              <p className="text-lg text-muted-foreground leading-relaxed">
                Whether you need a simple plumbing repair at your home in Zone 3 or a complete house build in Zone 5, Jiyology delivers professional workmanship. We are Level One 135% BEE compliant, SABS approved, and committed to quality on every project.
              </p>
            </div>
            <div className="bg-muted/30 rounded-2xl p-8 border border-border/60">
              <h3 className="text-xl font-bold text-foreground mb-4">Our Services in Meadowlands</h3>
              <ul className="space-y-4">
                {[
                  ...
                  { service: 'Ceiling Installation', href: '/services/ceiling-installation', desc: 'New ceilings & ceiling repairs' },
      ...
      <section className="py-20 bg-muted/30" aria-label="Soweto suburbs">
        <div className="container mx-auto px-4 max-w-6xl">
          <h2 className="text-3xl font-bold text-foreground mb-6 text-center">We Serve the Whole of Soweto Including Meadowlands</h2>
          <p className="text-lg text-muted-foreground text-center mb-12 max-w-3xl mx-auto">
            Meadowlands is just one of the many Soweto suburbs we serve. Our team is available across the township for all construction and plumbing needs.
          </p>
      ...
      <section className="py-20 bg-background" aria-label="FAQs">
        <div className="container mx-auto px-4 max-w-3xl">
          <h2 className="text-3xl font-bold text-foreground mb-8 text-center">Frequently Asked Questions About Our Meadowlands Services</h2>
