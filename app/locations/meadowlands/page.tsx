...
export default function MeadowlandsPage() {
  return (
    <>
            <script type="application/ld+json" dangerouslySetInnerHTML={{__html: JSON.stringify(locationServiceLdJson('Meadowlands', 'https://www.jiyology.co.za/locations/meadowlands'))}} />
