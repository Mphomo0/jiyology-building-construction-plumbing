...
export const metadata: Metadata = {
  title: 'Plumber & Builder in Orlando | Jiyology Construction',
  description: 'Trusted plumber and builder in Orlando, Soweto. Plumbing, construction, roofing, renovations & emergency services. SABS approved, BEE Level 1. Free quotes.',
  openGraph: {
    title: 'Best Plumber & Builder in Orlando | Jiyology Construction',
    description: 'Professional plumbing, construction, and renovation services in Orlando, Soweto. SABS approved materials, BEE Level 1. Free quotes for all projects.',
...
const faqs = [
  { q: 'Do you work on heritage houses in Orlando?', a: 'Yes. Orlando has many historic homes that require sensitive renovations. We have experience working on older properties while preserving their character and ensuring structural integrity.' },
  { q: 'Can you install a geyser in my Orlando home?', a: 'Absolutely. We install, repair, and replace geysers of all sizes in Orlando. We also install solar geysers for energy-conscious homeowners.' },
  { q: 'Do you offer paving services in Orlando?', a: 'Yes. We pave driveways, patios, and walkways in Orlando using interlocking blocks, concrete, and brick pavers. We also repair existing paved areas.' },
  { q: 'How soon can you start a project in Orlando?', a: 'We typically start small projects within one week. Larger builds and renovations may require a longer lead time depending on material availability and scope.' },
]
    ...
    <>
      ...
      <Script id="orlando-breadcrumb" type="application/ld+json">
        {JSON.stringify(breadcrumbLdJson([
          ...
          { name: 'Orlando', url: 'https://www.jiyology.co.za/locations/orlando' },
        ]))}
      </Script>

      <section className="relative pt-32 pb-20 md:pt-40 md:pb-28 bg-slate-950 overflow-hidden" aria-label="Orlando">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 z-10 text-center">
          <nav aria-label="Breadcrumb" className="mb-6">
            <ol className="flex items-center justify-center gap-2 text-sm text-neutral-400">
              ...
              <li><span className="mx-2">/</span></li>
              <li className="text-white font-medium" aria-current="page">Orlando</li>
            </ol>
          </nav>
          ...
          <p className="text-lg md:text-xl text-neutral-400 leading-relaxed max-w-3xl mx-auto">
            Jiyology Building Construction & Plumbing is your trusted partner for construction and plumbing services in Orlando, Soweto. SABS-approved materials, BEE Level 1, and over 10 years of local experience.
          </p>
      ...
      <section className="py-20 bg-background" aria-label="About serving Orlando">
        <div className="container mx-auto px-4 max-w-6xl">
          <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-6">Your Local Plumber & Builder in Orlando</h2>
          <div className="grid md:grid-cols-2 gap-12">
            <div>
              <p className="text-lg text-muted-foreground leading-relaxed mb-6">
                Orlando is one of Soweto oldest and most historically significant suburbs, home to landmarks like the Orlando Stadium and the iconic Walter Sisulu Square. Jiyology Building Construction & Plumbing has been serving Orlando residents for over a decade, helping them maintain and improve their homes with professional construction and plumbing services.
              </p>
              <p className="text-lg text-muted-foreground leading-relaxed mb-6">
                The housing stock in Orlando ranges from historic 1940s houses to modern townhouse developments. Our team is experienced in working with both old and new properties. We specialise in updating older homes with modern plumbing systems, new roofs, renovated bathrooms, and refreshed interiors while respecting the original character of the property.
              </p>
              <p className="text-lg text-muted-foreground leading-relaxed">
                From Orlando East to Orlando West, from the areas near the stadium to the quieter residential streets, we provide consistent quality across all jobs. As a Level One 135% BEE compliant company with SABS-approved materials, we bring trust and excellence to every Orlando project.
              </p>
            </div>
            <div className="bg-muted/30 rounded-2xl p-8 border border-border/60">
              <h3 className="text-xl font-bold text-foreground mb-4">Our Services in Orlando</h3>
      ...
      <section className="py-20 bg-muted/30" aria-label="Soweto suburbs">
        <div className="container mx-auto px-4 max-w-6xl">
          <h2 className="text-3xl font-bold text-foreground mb-6 text-center">We Serve the Whole of Soweto Including Orlando</h2>
          <p className="text-lg text-muted-foreground text-center mb-12 max-w-3xl mx-auto">
            Orlando is just one of the many Soweto suburbs we serve. Our team is available across the township for all construction and plumbing needs.
          </p>
      ...
      <section className="py-20 bg-background" aria-label="FAQs">
        <div className="container mx-auto px-4 max-w-3xl">
          <h2 className="text-3xl font-bold text-foreground mb-8 text-center">Frequently Asked Questions About Our Orlando Services</h2>
