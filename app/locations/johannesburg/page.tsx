...
const faqs = [
  {
    q: 'Do you handle commercial construction in Johannesburg?',
    a: 'Yes. We undertake commercial construction projects in Johannesburg including office fit-outs, retail renovations, and light industrial building work.',
  },
  {
    q: 'Can you work on heritage properties in Johannesburg CBD?',
    a: 'Yes. We have experience with heritage and listed buildings in the Johannesburg CBD and suburbs like Parktown and Houghton, working within preservation guidelines.',
  },
  {
    q: 'Do you serve Johannesburg northern suburbs?',
    a: 'Yes. We serve all Johannesburg areas including the northern suburbs such as Fourways, Sandton, Midrand, Randburg, and Roodepoort.',
  },
  {
    q: 'Are you insured for Johannesburg construction projects?',
    a: 'Yes. We carry full public liability insurance and all our work complies with Johannesburg building regulations and safety standards.',
  },
]
  ...
  return (
    <>
      ...
      >
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 z-10 text-center">
          ...
          <p className="text-lg md:text-xl text-neutral-400 leading-relaxed max-w-3xl mx-auto">
            ...
            building, plumbing, and renovation services across greater
            Johannesburg. SABS-approved materials, BEE Level 1, and over 10
            years of experience.
          </p>
      ...
      <section
        ...
        aria-label="About serving Johannesburg"
      >
        <div className="container mx-auto px-4 max-w-6xl">
          <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-6">
            Your Local Building Contractors in Johannesburg
          </h2>
          <div className="grid md:grid-cols-2 gap-12">
            <div>
              <p className="text-lg text-muted-foreground leading-relaxed mb-6">
                Johannesburg is a city of opportunity, and Jiyology Building
                Construction & Plumbing is proud to serve homeowners and
                businesses across the greater Johannesburg area. While our roots
                are in Soweto, our expertise extends to every corner of the
                city, from the northern suburbs to the south, and from the CBD
                to the western areas.
              </p>
              <p className="text-lg text-muted-foreground leading-relaxed mb-6">
                We handle a wide variety of projects in Johannesburg, including
                residential home builds and renovations, commercial fit-outs,
                retail space upgrades, and industrial maintenance work. Every
                project is managed to Johannesburg building standards using
                SABS-approved materials, with full compliance to municipal
                regulations.
              </p>
              <p className="text-lg text-muted-foreground leading-relaxed">
                As a Level One 135% BEE compliant company, 50% black woman
                owned, we are well positioned for government and private sector
                projects. Our team has the experience and capacity to deliver
                projects of any scale across Johannesburg. Contact us for a free
                site assessment and detailed quote.
              </p>
            </div>
            <div className="bg-muted/30 rounded-2xl p-8 border border-border/60">
              <h3 className="text-xl font-bold text-foreground mb-4">
                Our Services in Johannesburg
              </h3>
      ...
      <section className="py-20 bg-muted/30" aria-label="Soweto suburbs">
        <div className="container mx-auto px-4 max-w-6xl">
          <h2 className="text-3xl font-bold text-foreground mb-6 text-center">
            We Serve the Whole of Soweto Including Johannesburg
          </h2>
          <p className="text-lg text-muted-foreground text-center mb-12 max-w-3xl mx-auto">
            Johannesburg is just one of the many areas we serve. Our team is
            available across the city for all construction and plumbing needs.
          </p>
      ...
      <section className="py-20 bg-background" aria-label="FAQs">
        <div className="container mx-auto px-4 max-w-3xl">
          <h2 className="text-3xl font-bold text-foreground mb-8 text-center">
            Frequently Asked Questions About Our Johannesburg Services
          </h2>
