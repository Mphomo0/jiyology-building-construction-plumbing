...
export const metadata: Metadata = {
  title: 'Plumbing FAQ | Emergency Plumbing & Geyser Questions | Jiyology',
  description: 'Expert plumbing answers for Soweto and Johannesburg: burst pipes, blocked drains, geyser repairs, water pressure, costs, and emergency services.',
    ...
    <>
      ...
      <Script id="plumbing-faq-breadcrumb" type="application/ld+json">
        {JSON.stringify(breadcrumbLdJson([
          ...
          { name: 'Plumbing FAQ', url: 'https://www.jiyology.co.za/faq/plumbing' },
        ]))}
      </Script>
      ...
      <section className="relative pt-32 pb-20 md:pt-40 md:pb-28 bg-slate-950 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 z-10 text-center">
          <nav aria-label="Breadcrumb" className="text-sm text-neutral-500 mb-6">
            <Link href="/" className="hover:text-[#33b6db]">Home</Link> / <Link href="/faq" className="hover:text-[#33b6db]">FAQ</Link> / <span className="text-neutral-400">Plumbing</span>
          </nav>
          ...
          <p className="text-lg md:text-xl text-neutral-400 leading-relaxed max-w-3xl mx-auto">
            Expert answers about plumbing emergencies, geyser installation, drain cleaning, and water pressure for Soweto homeowners.
          </p>
        </div>
      </section>
      ...
      <section className="py-16 bg-muted/20">
        <div className="container mx-auto px-4 max-w-4xl text-center">
          <h2 className="text-3xl font-bold text-foreground mb-4">Have a Plumbing Emergency?</h2>
          <p className="text-muted-foreground mb-8 max-w-2xl mx-auto">
            Burst pipe? Blocked drain? Leaking geyser? We&rsquo;re available 24/7 across Soweto.
          </p>
          <div className="flex justify-center gap-4 flex-wrap">
            <Link href="/services/plumbing" className="inline-flex items-center justify-center px-8 py-3 rounded-full bg-[#33b6db] text-white font-semibold hover:bg-[#33b6db]/90 transition-all">
              Plumbing Services
            </Link>
            <a href="tel:0606436664" className="inline-flex items-center justify-center px-8 py-3 rounded-full border border-[#33b6db] text-[#33b6db] font-semibold hover:bg-[#33b6db] hover:text-white transition-all">
              Call 060 643 6664
            </a>
            <Link href="/contact" className="inline-flex items-center justify-center px-8 py-3 rounded-full border border-border text-muted-foreground font-semibold hover:bg-muted transition-all">
              Contact Us
            </Link>
          </div>
        </div>
