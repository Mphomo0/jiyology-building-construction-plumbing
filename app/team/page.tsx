...
export const metadata: Metadata = {
  ...
  description: 'Meet Vusi Jiya and Lerato Jiya, the founders of Jiyology Building Construction & Plumbing. Over 10 years of experience in Soweto and Johannesburg.',
  openGraph: {
    title: 'Meet Our Team | Jiyology Construction & Plumbing Soweto',
    description: 'Founded by Vusi and Lerato Jiya — experienced construction and plumbing professionals serving Soweto and Johannesburg.',
...
const teamMembers = [
  ...
  },
  {
    ...
    description: 'Lerato Jiya co-founded Jiyology with a vision to create a construction and plumbing company that puts clients first. As a 50% black woman-owned enterprise, Jiyology reflects Lerato commitment to transformation and excellence in the South African building industry.',
  ...
  return (
    <>
      ...
      {teamMembers.map((member) => (
        <Script key={member.name} id={`person-${member.name}`} type="application/ld+json">
          {JSON.stringify(personLdJson(member.name, member.role, member.description))}
        </Script>
      ))}

      <section className="relative pt-32 pb-20 md:pt-40 md:pb-28 bg-slate-950 overflow-hidden" aria-label="Our Team">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 z-10 text-center">
          <nav aria-label="Breadcrumb" className="mb-6">
            <ol className="flex items-center justify-center gap-2 text-sm text-neutral-400">
              ...
              <li className="text-white font-medium" aria-current="page">Our Team</li>
            </ol>
          </nav>
          ...
          <p className="text-lg md:text-xl text-neutral-400 leading-relaxed max-w-2xl mx-auto">
            The experienced professionals behind Jiyology Building Construction & Plumbing, dedicated to delivering quality craftsmanship across Soweto and Johannesburg.
          </p>
        </div>
      </section>
      ...
      <section className="py-24 bg-background" aria-label="Team members">
        <div className="container mx-auto px-4 max-w-6xl">
          <div className="grid md:grid-cols-2 gap-12">
            {teamMembers.map((member) => (
              <article key={member.name} className="bg-muted/30 rounded-2xl p-8 border border-border/60">
                ...
                <p className="text-[#33b6db] font-semibold text-sm mb-4">{member.role}</p>
          ...
          <div className="mt-16 bg-muted/30 rounded-2xl p-8 md:p-12 border border-border/60">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              <div className="p-6 bg-background rounded-xl border border-border/60">
                ...
                <p className="text-muted-foreground text-sm">Over a decade of construction and plumbing expertise serving Soweto and Johannesburg.</p>
              </div>
              <div className="p-6 bg-background rounded-xl border border-border/60">
                <h3 className="font-bold text-lg mb-2">BEE Level 1</h3>
                <p className="text-muted-foreground text-sm">135% BEE compliant, 50% black woman owned. Committed to transformation.</p>
              </div>
              <div className="p-6 bg-background rounded-xl border border-border/60">
                <h3 className="font-bold text-lg mb-2">SABS Approved</h3>
                <p className="text-muted-foreground text-sm">All materials meet South African Bureau of Standards quality requirements.</p>
              </div>
            </div>
          </div>
          ...
          <div className="mt-16 text-center">
            ...
            <p className="text-lg text-muted-foreground mb-8 max-w-2xl mx-auto">
              Contact Vusi or Lerato today for a free consultation and quote for your construction or plumbing project.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a href="/contact" className="inline-flex items-center justify-center px-8 py-3 bg-neutral-950 hover:bg-[#33b6db] text-white font-semibold rounded-lg transition-colors">
                Get a Free Quote
              </a>
              <a href="tel:+27119310157" className="inline-flex items-center justify-center px-8 py-3 border border-border text-foreground font-semibold rounded-lg hover:bg-muted/50 transition-colors">
                Call (011) 931 0157
              </a>
            </div>
          </div>
