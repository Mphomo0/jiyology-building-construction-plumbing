  ...
  const pavingServices = [
    {
      ...
      desc: 'Enhance your home curb appeal with professionally paved driveways using durable interlocking blocks or concrete pavers designed to withstand vehicles.',
      items: [
    ...
    {
      icon: TreePine,
      title: 'Patio & Walkway Paving',
      desc: 'Create beautiful outdoor living spaces with custom patio paving and garden walkways. Perfect for entertaining, relaxation, and improving property flow.',
      items: [
        'Patio paving',
        'Garden pathways',
        'Pool surrounds',
    ...
    },
    {
      ...
      desc: 'Large-scale commercial paving solutions for retail centres, office parks, industrial sites, and public spaces. Durable materials for high-traffic areas.',
      items: [
        'Retail parking lots',
        'Office park paving',
        'Industrial flooring',
    ...
    },
    {
      ...
      desc: 'Professional repair services for damaged, sunken, or uneven paved surfaces. We restore safety, appearance, and functionality to your existing paving.',
      items: [
        'Block replacement',
        'Re-sanding & sealing',
        'Re-leveling',
  ...
  return (
    <>
      ...
      >
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 z-10 text-center">
          ...
          <p className="text-lg md:text-xl text-neutral-400 leading-relaxed max-w-3xl mx-auto">
            Transform your property with quality paving solutions. Driveways,
            patios, walkways, and commercial paving using durable interlocking
            blocks and concrete.
          </p>
      ...
      <section
        ...
        aria-label="Paving services overview"
      >
        <div className="container mx-auto px-4 max-w-6xl">
          <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-6">
            Complete Paving Services for Soweto & Johannesburg
          </h2>
          <p className="text-lg text-muted-foreground leading-relaxed mb-12 max-w-4xl">
            At Jiyology Building Construction & Plumbing, we specialise in
            professional paving solutions that enhance the beauty,
            functionality, and value of your property. Whether you need a new
            driveway, a patio for outdoor entertaining, or large-scale
            commercial paving, our team delivers precision and quality in every
            project across Soweto, Johannesburg, and Gauteng.
          </p>
          <p className="text-lg text-muted-foreground leading-relaxed mb-12 max-w-4xl">
            We work with a variety of paving materials including interlocking
            concrete blocks, clay pavers, and concrete slabs to suit your
            aesthetic preferences and budget. Proper base preparation is
            critical for long-lasting paving, and our team follows strict
            installation protocols including correct excavation, compaction,
            sand bedding, and edge restraint to ensure your paved surfaces
            remain level and durable for years to come.
          </p>
          ...
          <div className="bg-muted/30 rounded-2xl p-8 md:p-12 border border-border/60">
            <h2 className="text-2xl font-bold text-foreground mb-6">
              Why Choose Jiyology for Paving?
            </h2>
            <div className="grid md:grid-cols-3 gap-6">
              <div>
                <h3 className="font-bold text-lg mb-2">Quality Materials</h3>
                <p className="text-muted-foreground text-sm">
                  We use only SABS-approved paving materials that are durable,
                  fade-resistant, and designed to withstand South African
                  weather conditions and heavy use.
                </p>
              </div>
              <div>
                <h3 className="font-bold text-lg mb-2">Expert Installation</h3>
                <p className="text-muted-foreground text-sm">
                  Our paving team follows strict installation standards
                  including proper base preparation, compaction, and finishing
                  to ensure long-lasting, level surfaces.
                </p>
              </div>
              <div>
                <h3 className="font-bold text-lg mb-2">Free Quotes & Advice</h3>
                <p className="text-muted-foreground text-sm">
                  We provide free consultations and quotes, helping you choose
                  the right paving material and design for your property. No
      ...
      <section className="py-20 bg-muted/30" aria-label="Service areas">
        <div className="container mx-auto px-4 max-w-6xl">
          <h2 className="text-3xl font-bold text-foreground mb-6 text-center">
            Paving Services Across Soweto & Johannesburg
          </h2>
          <p className="text-lg text-muted-foreground text-center mb-12 max-w-3xl mx-auto">
            We provide paving services across Soweto, Johannesburg, and all
            surrounding areas. Contact us for a free quote on your paving
            project.
          </p>
      ...
      <section className="py-16 bg-muted/30">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl font-bold text-foreground mb-4">Paving Resources</h2>
          <p className="text-muted-foreground mb-8 max-w-2xl mx-auto">
            Explore our paving guides and FAQ for more information.
          </p>
          <div className="flex flex-wrap justify-center gap-4">
            <Link href="/faq/paving" className="inline-flex items-center px-6 py-3 rounded-full bg-[#33b6db] text-white font-semibold hover:bg-[#33b6db]/90 transition-all">
              Paving FAQ
            </Link>
            <Link href="/services/tiling-painting" className="inline-flex items-center px-6 py-3 rounded-full border border-[#33b6db] text-[#33b6db] font-semibold hover:bg-[#33b6db] hover:text-white transition-all">
              Tiling &amp; Painting
            </Link>
