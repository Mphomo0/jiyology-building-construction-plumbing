    ...
    <>
      ...
      <section className="py-16 bg-muted/30">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl font-bold text-foreground mb-4">Tiling &amp; Painting Resources</h2>
          <p className="text-muted-foreground mb-8 max-w-2xl mx-auto">
            Explore our tiling and painting guides and FAQ for more information.
          </p>
          <div className="flex flex-wrap justify-center gap-4">
            <Link href="/faq/tiling-painting" className="inline-flex items-center px-6 py-3 rounded-full bg-[#33b6db] text-white font-semibold hover:bg-[#33b6db]/90 transition-all">
              Tiling &amp; Painting FAQ
            </Link>
            <Link href="/services/paving" className="inline-flex items-center px-6 py-3 rounded-full border border-[#33b6db] text-[#33b6db] font-semibold hover:bg-[#33b6db] hover:text-white transition-all">
              Paving Services
            </Link>
