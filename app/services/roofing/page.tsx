...
export const metadata: Metadata = {
  ...
  openGraph: og({
    ...
    description:
      'Professional roofing installation, repairs, and maintenance. SABS-approved materials. Serving Soweto, Protea Glen, Dobsonville, Diepkloof, and Johannesburg.',
      ...
      >
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 z-10 text-center">
          ...
          <p className="text-lg md:text-xl text-neutral-400 leading-relaxed max-w-3xl mx-auto">
            Complete roofing solutions from installation to repairs.
            SABS-approved materials, expert craftsmanship, and free quotes for
      ...
      >
        <div className="container mx-auto px-4 max-w-6xl">
          <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-6">
            Complete Roofing Solutions for Soweto & Johannesburg
          </h2>
          <p className="text-lg text-muted-foreground leading-relaxed mb-12 max-w-4xl">
            At Jiyology Building Construction & Plumbing, we provide
            comprehensive roofing services for residential and commercial
            properties across Soweto, Johannesburg, and all of Gauteng. Whether
            you need a new roof installation, roof repairs, or maintenance, our
            team delivers quality workmanship using SABS-approved materials.
          </p>
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-16">
            <div className="bg-muted/30 rounded-2xl p-8 border border-border/60">
              ...
              <p className="text-muted-foreground mb-4">
                Concrete and clay roof tiles are a popular choice for homes in
                South Africa due to their durability, aesthetic appeal, and
                excellent insulation properties. We install a wide variety of
                roof tile styles and colours to match your home design.
              </p>
            ...
            <div className="bg-muted/30 rounded-2xl p-8 border border-border/60">
              ...
              <p className="text-muted-foreground mb-4">
                IBR, Chromodek, and corrugated roof sheeting is ideal for both
                residential and commercial properties. Lightweight, durable, and
                cost-effective, roof sheets are a practical choice for projects
                across Soweto and Johannesburg.
              </p>
              <ul className="space-y-2">
                {[
                  'IBR sheeting',
                  'Chromodek installation',
                  'Corrugated iron',
            ...
            <div className="bg-muted/30 rounded-2xl p-8 border border-border/60">
              <h3 className="text-2xl font-bold text-foreground mb-4">
                Roof Erection & New Builds
              </h3>
              <p className="text-muted-foreground mb-4">
                From new home construction to commercial buildings, our team
                handles complete roof erection projects. We manage everything
                from truss installation to final sheeting, ensuring your roof is
                structurally sound and weathertight.
              </p>
              <ul className="space-y-2">
                {[
                  'Truss installation',
            ...
            <div className="bg-muted/30 rounded-2xl p-8 border border-border/60">
              ...
              <p className="text-muted-foreground mb-4">
                Leaking roofs, missing tiles, storm damage — our team provides
                fast, reliable roof repair services across Soweto and
                Johannesburg. We identify the root cause and provide lasting
          ...
          <div className="bg-muted/30 rounded-2xl p-8 md:p-12 border border-border/60">
            <h2 className="text-2xl font-bold text-foreground mb-6">
              Why Choose Jiyology for Roofing in Soweto?
            </h2>
            <div className="grid md:grid-cols-3 gap-6">
              <div>
                ...
                <p className="text-muted-foreground text-sm">
                  All roofing materials meet South African Bureau of Standards
              ...
              <div>
                ...
                <p className="text-muted-foreground text-sm">
                  135% BEE compliant, 50% black woman owned. We meet all
                  government and corporate procurement requirements.
                </p>
              </div>
              <div>
                <h3 className="font-bold text-lg mb-2">Experienced Team</h3>
                <p className="text-muted-foreground text-sm">
                  Over 10 years of roofing experience across residential and
                  commercial projects in Soweto and Johannesburg.
                </p>
              </div>
            </div>
          </div>
      ...
      <section className="py-20 bg-muted/30" aria-label="Service areas">
        <div className="container mx-auto px-4 max-w-6xl">
          <h2 className="text-3xl font-bold text-foreground mb-6 text-center">
            Roofing Services Across Soweto & Johannesburg
          </h2>
          <p className="text-lg text-muted-foreground text-center mb-12 max-w-3xl mx-auto">
            We provide roofing services throughout the greater Soweto area and
            Johannesburg. No matter where you are, our team will get your roof
            sorted.
          </p>
